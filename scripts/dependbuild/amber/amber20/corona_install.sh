...
BUILDDIR="${BUILDDIR:-/g/g92/zhang30/W/kras/AMBER20/amber20_src/build_corona}"
MYCONDAENV="${MYCONDAENV:-/usr/gapps/bbs/TOSS-4-Corona/miniconda3}"
INSTALLDIR="${INSTALLDIR:-/usr/gapps/bbs/TOSS-4-Corona/amber20}"
...
#   ```
OLCF_GCC_ROOT=/usr/tce/packages/gcc-tce/gcc-10.2.1
