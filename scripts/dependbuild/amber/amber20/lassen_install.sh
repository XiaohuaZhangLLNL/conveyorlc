...
module load gcc/8.3.1 spectrum-mpi cuda \
  cmake netcdf/4.7.0  fftw

# Buildtime modules - Probably only needed at buildtime.
module load flex git

SRCDIR="${SRCDIR:-/usr/gapps/bbs/CORAL-Sierra/amber20_src}"
BUILDDIR="${BUILDDIR:-/usr/gapps/bbs/CORAL-Sierra/amber20_src/build}"
MYCONDAENV="${MYCONDAENV:-/usr/gapps/bbs/CORAL-Sierra/amber20/miniconda}"
INSTALLDIR="${INSTALLDIR:-/usr/gapps/bbs/CORAL-Sierra/amber20/}"
