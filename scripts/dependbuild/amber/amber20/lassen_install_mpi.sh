...
module load gcc/8.3.1 spectrum-mpi cuda \
  cmake/3.18.0 netcdf/4.7.0  fftw/3.3.8
...
BUILDDIR="${BUILDDIR:-/g/g92/zhang30/W/kras/AMBER20/amber20_src/build_mpi2}"
MYCONDAENV="${MYCONDAENV:-/usr/gapps/bbs/CORAL-Lassen/amber20/miniconda}"
INSTALLDIR="${INSTALLDIR:-/usr/gapps/bbs/CORAL-Lassen/amber20/}"
