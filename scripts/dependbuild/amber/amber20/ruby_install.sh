...
BUILDDIR="${BUILDDIR:-/g/g92/zhang30/W/kras/AMBER20/amber20_src/build_ruby_mpi2}"
#MYCONDAENV="${MYCONDAENV:-/usr/gapps/bbs/TOSS-3/amber20_omp/miniconda}"
MYCONDAENV="${MYCONDAENV:-/usr/gapps/bbs/TOSS-3/amber20/miniconda}"
#INSTALLDIR="${INSTALLDIR:-/usr/gapps/bbs/TOSS-3/amber20_omp}"
INSTALLDIR="${INSTALLDIR:-/usr/gapps/bbs/TOSS-3/amber20}"
