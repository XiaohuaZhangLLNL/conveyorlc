...
module load flex bison git

SRCDIR="${SRCDIR:-$HOME/PROGRAMS/amber20_src}"
BUILDDIR="${BUILDDIR:-$MEMBERWORK/chm169/tmp/amber20-build}"
MYCONDAENV="${MYCONDAENV:-/ccs/proj/chm169/$USER/summit/opt/amber20_conda}"
INSTALLDIR="${INSTALLDIR:-/ccs/proj/chm169/$USER/summit/opt/amber20}"
...
#   ```
#   -DCMAKE_<LANG>_LINK_FLAGS="-Wl,-rpath,$OLCF_<PKG>_ROOT/lib[64] -L$OLCF_<PKG>_ROOT
/lib[64]"
#   ```
