...
module load gcc/8.3.1 spectrum-mpi cuda/11.8.0 \
  cmake/3.23.1 netcdf/4.7.0  fftw/3.3.9
...
BUILDDIR="${BUILDDIR:-/g/g92/zhang30/W/kras/AMBER22/standard/amber22_src/build2}"
MYCONDAENV="${MYCONDAENV:-/usr/gapps/bbs/CORAL-Lassen/amber22/miniconda3/}"
INSTALLDIR="${INSTALLDIR:-/usr/gapps/bbs/CORAL-Lassen/amber22/}"
...
export OLCF_GCC_ROOT=/usr/tce/packages/gcc/gcc-8.3.1/
